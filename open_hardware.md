...
|---|---|---|---|---|
| **meshtastic设备-Fucktec** | [oshwhub.com](https://pro.lceda.cn/editor#id=03fbd7d6ad2d4bc488040531364920eb,tab=*50f287428cd7428690cb6aa73281e293) | nRF52 | LoRa module | FakeTec variant with screen, GPS, and an onboard MPPT solar charge controller squeezed into the original FakeTec footprint; circuits are modular so sections can be omitted |
