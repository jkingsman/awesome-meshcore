...
| **meshtastic 五向按钮** | [oshwhub.com](https://oshwhub.com/eda_vpdksavtb) | — (expansion only) | — | Not a node — a universal 5-way joystick expansion module to bolt onto any Meshtastic device for standalone navigation input without a phone |
| **BPTBStec（已验证）** | [oshwhub.com](https://oshwhub.com/allrounderkali) | nRF52 | LoRa module | FakeTec V3/V5-derived, hardware-verified; layout reworked so all components can be reflowed on a hot plate rather than hand-soldered |
